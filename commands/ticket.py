...
class Ticket(commands.Cog):
    ...
    @commands.command(name='ticket', help='Create a ticket message inside a channel')
    @commands.has_permissions(administrator=True)
    async def createticket(self, ctx, channel):
    ...
    @commands.command(name='close', help='Close a ticket')
    @commands.has_permissions(administrator=True)
            ...
            for items in channel_id:
                if user_channel_id in items:
                    ...
                    if guild_roles is None:
                        ...
                        admin_role = discord.utils.get(find_guild.roles, name='🏆 Manager Torneios')
                        ...
                        category = find_guild.get_channel(payload.channel_id).category
